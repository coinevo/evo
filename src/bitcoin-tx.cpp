...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " evo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  evo-tx [options] <hex-tx> [commands]  Update hex-encoded evo transaction\n" +
            "or:     evo-tx [options] -create [commands]   Create hex-encoded evo transaction\n" +
            "\n";
