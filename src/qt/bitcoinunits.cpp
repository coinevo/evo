...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EVO");
    case mBTC: return QString("mEVO");
    case uBTC: return QString::fromUtf8("μEVO (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Evos");
    case mBTC: return QString("Milli-Evos (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Evos (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
