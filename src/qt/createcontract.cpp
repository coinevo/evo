    ...
    m_results(1)
{
    ...
    ui->labelSenderAddress->setToolTip(tr("The evo address that will be used to create the contract."));
...
void CreateContract::setLinkLabels()
{
    ...
    ui->labelSolidity->setText("<a href=\"https://emix.coinevo.tech/\">Solidity compiler</a>");
}
...
void CreateContract::on_gasInfoChanged(quint64 blockGasLimit, quint64 minGasPrice, quint64 nGasPrice)
{
    ...
    ui->labelGasPrice->setToolTip(tr("Gas price: EVO price per gas unit. Default = %1, Min = %2").arg(QString::fromStdString(FormatMoney(DEFAULT_GAS_PRICE))).arg(QString::fromStdString(FormatMoney(minGasPrice))));
