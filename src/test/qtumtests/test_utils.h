...
inline void initState(){
    ...
    globalState = std::unique_ptr<QtumState>(new QtumState(dev::u256(0), QtumState::openDB(dirQtum, hashDB, dev::WithExisting::Trust), dirQtum + "/evoDB", dev::eth::BaseState::Empty));
