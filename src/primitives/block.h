...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // evo
        hashUTXORoot.SetNull(); // evo
    ...
    virtual bool IsProofOfStake() const //evo
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //evo
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //evo
    {
